...
assert_equal "$actual_existing_alias_definition1" "$expected_existing_alias_definition1"
...
assert_equal "$actual_alias_definition1" "$expected_alias_definition1"

actual_alias_definition2=${__sherpa__env_stash__aliases_to_restore__parent_child[*]:1:1}
assert_equal "$actual_alias_definition2" "$expected_alias_definition2"
...
assert_undefined "__sherpa__env_stash__aliases_to_restore__parent_child"
assert_undefined "__sherpa__env_stash__aliases_to_remove__parent_child"
