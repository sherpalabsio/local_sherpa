...
is "$(which subalias_1)" "subalias_1 not found" "Subfolder env is unloaded (subalias_1)"
is "$(which subfunction_1)" "subfunction_1 not found" "Subfolder env is unloaded (subfunction_1)"
