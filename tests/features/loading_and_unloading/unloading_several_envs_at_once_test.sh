...
# ==============================================================================
# PWD: /project_1 (with local env)
cd project_1
# == Senety check: Project 1 env is loaded
assert_equal "$var_1" "LOCAL VAR PROJECT 1" "Project 1 env is loaded (var_1)"

# ==============================================================================
# PWD: /project_1/subfolder_with_no_local_env (with no local env)
cd subfolder_with_no_local_env

# ==============================================================================
# PWD: /project_1/subfolder_with_no_local_env/subproject (with local env)
cd subproject
