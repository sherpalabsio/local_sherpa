...
# readonly SHERPA_LOG_LEVEL_DEBUG
export SHERPA_LOG_LEVEL_INFO=1
# readonly SHERPA_LOG_LEVEL_INFO
export SHERPA_LOG_LEVEL_WARN=2
# readonly SHERPA_LOG_LEVEL_WARN
export SHERPA_LOG_LEVEL_ERROR=3
# readonly SHERPA_LOG_LEVEL_ERROR
export SHERPA_LOG_LEVEL_SILENT=4
# readonly SHERPA_LOG_LEVEL_SILENT
